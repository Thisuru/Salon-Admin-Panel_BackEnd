...
const sendSuccessEmail = async (req, res) => {
  ...
  try {
    ...
    var mailOptions = {
      ...
      //             </head>
      //             <body>
      //             <h1 style="color:blue;">${req.body.message}</h1>
      //             </body>
      //         </html>
      //       `
            ...
            <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;">
              <tr>
                <td class="bg_white logo" style="padding: 1em 2.5em; text-align: center">
                  <h1><a href="#">Admin Invitation</a></h1>
                </td>
              </tr><!-- end tr -->
              <tr>
                <td valign="middle" class="hero" style="background-image: url('https://github.com/ColorlibHQ/email-templates/blob/master/1/images/bg_1.jpg?raw=true'); background-size: cover; height: 400px;">
                  <table>
                    <tr>
                      <td>
                        <div class="text" style="padding: 0 3em; text-align: center;">
                          <h2>Clieck on the below URL</h2>
